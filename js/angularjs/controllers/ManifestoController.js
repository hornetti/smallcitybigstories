app.controller('ManifestoController', ['$scope', function($scope) {
	...
	$scope.manifestoTesto = [
    	{
    		paragraf : "Il digitale ha imposto ai media nuovi ritmi e nuove sfide, spingendoli in acque ancora inesplorate; l&rsquo;ennesima prova che il giornalismo è chiamato a superare non riguarda solamente l&rsquo;approccio alle nuove tecnologie, ma tocca nel profondo gli stessi ingranaggi che quotidianamente lo definiscono."
    	},
    	{
    		paragraf : "Crediamo sia necessario ripensare la sfera mediatica, combinando i diversi strumenti che il digitale ci offre in modo da facilitare la comprensione dell&rsquo;utente. È sbagliato pensare che i lettori su Internet siano interessati solamente ad articoli di impatto, veloci e frivoli: il nostro pubblico cerca più giornalismo immersivo in cui investire risorse e impegno."
    	},
    	{
    	...
    	{
    		paragraf : "Se è vero che il cambiamento è l&rsquo;unica costante del giornalismo, allora è arrivato il momento di assecondarlo."
    	}
    ];	
}]);