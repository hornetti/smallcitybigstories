    ...
    if (supportsvideo) {
        var index = 0,
            ...
            video = $('#video1').bind('play', function () {
                playing = true;
                npAction.html('<rect x="18.2" y="31.3" class="PTEKStroke Stroke2px" width="5" height="17"/><rect x="28.2" y="31.3" class="PTEKStroke Stroke2px" width="5" height="17"/>');
            }).bind('pause', function () {
                playing = false;
                npAction.html('<polygon class="PTEKStroke Stroke2px" points="19.2,30.1 35.4,39.5 19.2,48.9"/>');
            }).bind('ended', function () {
                npAction.html('<polygon class="PTEKStroke Stroke2px" points="19.2,30.1 35.4,39.5 19.2,48.9"/>');
            ...
            circle = $('svg#Structure circle').click(function () {
            ...
            loadTrack = function (id) {
                ...
                $('svg#Structure circle:eq(' + id + ')').addClass('ActiveCircle');
