app.controller('InterviewController_gabriele_bandini', ['$scope', '$window', function($scope, $window) {            
    ...
    angular.element(document).ready(function() {
        ...
        jQuery(function ($) {
            ...
            if (supportsvideo) {
                var index = 0,
                    playing = false,
                    mediaPath = 'http://www.smallcitybigstories.com/video/gabriele_bandini/',
                    extension = '',
                    tracks = [{
                        "track": 1,
                        "name": "storia",
                        "length": "01:15",
                        "file": "01_gabrielebandini_storia"
                    }, {
                        "track": 2,
                        "name": "nascita",
                        "length": "01:19",
                        "file": "02_gabrielebandini_nascita"
                    }, {
                        "track": 3,
                        "name": "locale",
                        "length": "01:15",
                        "file": "03_gabrielebandini_locale"
                    }, {
                        "track": 4,
                        "name": "comunita",
                        "length": "01:19",
                        "file": "04_gabrielebandini_comunita"
                    }, {
                        "track": 5,
                        "name": "abilita",
                        "length": "01:15",
                        "file": "05_gabrielebandini_abilita"
                    }, {
                        "track": 6,
                        "name": "team",
                        "length": "01:19",
                        "file": "06_gabrielebandini_team"
                    }, {
                        "track": 7,
                        "name": "digitale",
                        "length": "01:15",
                        "file": "07_gabrielebandini_digitale"
                    }, {
                        "track": 8,
                        "name": "scuola",
                        "length": "01:19",
                        "file": "08_gabrielebandini_scuola"
                    }, {
                        "track": 9,
                        "name": "ostacoli",
                        "length": "01:15",
                        "file": "09_gabrielebandini_ostacoli"
                    }, {
                        "track": 10,
                        "name": "madeinitaly",
                        "length": "01:19",
                        "file": "10_gabrielebandini_madeinitaly"
                    }, {
                        "track": 11,
                        "name": "estero",
                        "length": "01:15",
                        "file": "11_gabrielebandini_estero"
                    }, {
                        "track": 12,
                        "name": "fallimento",
                        "length": "01:19",
                        "file": "12_gabrielebandini_fallimento"
                    }, {
                        "track": 13,
                        "name": "successo",
                        "length": "01:19",
                    ...
                    video = $('#VideoIntervista').bind('play', function () {
                        playing = true;
                        npAction.html('<rect x="18.2" y="31.3" class="Stroke2px MAVStroke" width="5" height="17"/><rect x="28.2" y="31.3" class="Stroke2px MAVStroke" width="5" height="17"/>');
                    }).bind('pause', function () {
                        playing = false;
                        npAction.html('<polygon class="Stroke2px MAVStroke" points="19.2,30.1 35.4,39.5 19.2,48.9"/>');
                    }).bind('ended', function () {
                        npAction.html('<polygon class="Stroke2px MAVStroke" points="19.2,30.1 35.4,39.5 19.2,48.9"/>');
